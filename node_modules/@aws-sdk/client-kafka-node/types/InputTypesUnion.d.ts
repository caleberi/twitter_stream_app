...
export declare type InputTypesUnion = CreateClusterInput | CreateConfigurationInput | DeleteClusterInput | DescribeClusterInput | DescribeClusterOperationInput | DescribeConfigurationInput | DescribeConfigurationRevisionInput | GetBootstrapBrokersInput | ListClusterOperationsInput | ListClustersInput | ListConfigurationRevisionsInput | ListConfigurationsInput | ListNodesInput | ListTagsForResourceInput | TagResourceInput | UntagResourceInput | UpdateBrokerStorageInput | UpdateClusterConfigurationInput;
