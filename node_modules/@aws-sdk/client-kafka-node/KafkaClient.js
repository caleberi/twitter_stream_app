...
var KafkaConfiguration_1 = require("./KafkaConfiguration");
...
var KafkaClient = /** @class */ (function () {
    function KafkaClient(configuration) {
        ...
        this.config = __aws_sdk_config_resolver.resolveConfiguration(configuration, KafkaConfiguration_1.configurationProperties, this.middlewareStack);
    ...
    KafkaClient.prototype.send = function (command, cb) {
